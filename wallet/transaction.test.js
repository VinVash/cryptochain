...
describe('Transaction', () => {
    let transaction, senderWallet, recipient, amount; // sending amount to recipient.
        ...
        describe('when the transaction is invalid', () => {
            describe('and a transaction outputMap is invalid', () => {
                it('returns false and logs an error', () => {
                    transaction.outputMap[senderWallet.publicKey] = 999999; // messed up with the data so that the expect statement returns false.
            ...
            describe('and a transaction input signature is invalid', () => {
                it('returns false and logs an error', () => {
                    ...
                    transaction.input.signature = new Wallet().sign('data'); // messed up with the data so that the expect statement returns false.
                    // console.log(transaction.input.signature);
                    expect(Transaction.validTransaction(transaction)).toBe(false);
                    expect(errorMock).toHaveBeenCalled();
                });
    ...
    describe('update()', () => { // the update function is going to have the ability to add a new amount for a new recipient in an existing transaction outputMap.
